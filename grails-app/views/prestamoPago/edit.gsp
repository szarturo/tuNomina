...
<html>
	...
	<body>
		<a href="#edit-prestamoPago" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-prestamoPago" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${prestamoPagoInstance?.version}" />
				<fieldset class="form">
