	...
	<body>
		...
		<div id="show-evento" class="content scaffold-show" role="main">
			...
			<ol class="property-list evento">
				...
				<g:if test="${eventoInstance?.evento}">
				<li class="fieldcontain">
					<span id="evento-label" class="property-label"><g:message code="evento.evento.label" default="Evento" /></span>
					
						<span class="property-value" aria-labelledby="evento-label"><g:fieldValue bean="${eventoInstance}" field="evento"/></span>
