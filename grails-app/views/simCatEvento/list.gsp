			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="evento" title="${message(code: 'evento.evento.label', default: 'Evento')}" />
				...
				<g:each in="${eventoInstanceList}" status="i" var="eventoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${eventoInstance.id}">${fieldValue(bean: eventoInstance, field: "evento")}</g:link></td>
