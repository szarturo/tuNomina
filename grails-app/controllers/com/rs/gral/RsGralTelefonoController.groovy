...
class RsGralTelefonoController {
    ...
    def save() {
		...
		flash.message = message(code: 'default.created.message', args: [message(code: 'rsGralTelefono.label', default: 'RsGralTelefono'), rsGralTelefonoInstance.id])
    ...
    def show() {
        ...
        if (!rsGralTelefonoInstance) {
			flash.message = message(code: 'default.not.found.message', args: [message(code: 'rsGralTelefono.label', default: 'RsGralTelefono'), params.id])
    ...
    def update() {
        ...
        if (params.version) {
            ...
            if (rsGralTelefonoInstance.version > version) {
                rsGralTelefonoInstance.errors.rejectValue("version", "default.optimistic.locking.failure",
                          [message(code: 'rsGralTelefono.label', default: 'RsGralTelefono')] as Object[],
		...
		flash.message = message(code: 'default.updated.message', args: [message(code: 'rsGralTelefono.label', default: 'RsGralTelefono'), rsGralTelefonoInstance.id])
        redirect(action: "show", id: rsGralTelefonoInstance.id)
    }
    ...
    def delete() {
        ...
        try {
			...
			flash.message = message(code: 'default.deleted.message', args: [message(code: 'rsGralTelefono.label', default: 'RsGralTelefono'), params.id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
			flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'rsGralTelefono.label', default: 'RsGralTelefono'), params.id])
